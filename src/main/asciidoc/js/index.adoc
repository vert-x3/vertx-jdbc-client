...
The client API is represented with the interface `link:../../jsdoc/jdbc_client-JDBCClient.html[JDBCClient]`.
...
The first call to `link:../../jsdoc/jdbc_client-JDBCClient.html#createShared[JDBCClient.createShared]`
...
In that case you can use `link:../../jsdoc/jdbc_client-JDBCClient.html#createNonShared[JDBCClient.createNonShared]`.
...
This is equivalent to calling `link:../../jsdoc/jdbc_client-JDBCClient.html#createShared[JDBCClient.createShared]`
...
Once you've created a client you use `link:../../jsdoc/jdbc_client-JDBCClient.html#getConnection[getConnection]` to get
a connection.
...
The connection is an instance of `link:../../jsdoc/sql_connection-SQLConnection.html[SQLConnection]` which is a common interface not only used by
