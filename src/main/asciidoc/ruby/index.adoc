...
----
compile 'io.vertx:vertx-jdbc-client:3.5.0-SNAPSHOT'
----
...
Once you've created a client you use `link:../../yardoc/VertxSql/SQLClient.html#get_connection-instance_method[getConnection]` to get
a connection.
