...
`JDBCPool.GENERATED_KEYS_LIST`. For example:

[source,$lang]
----
{@link examples.JDBCSqlClientExamples#exampleGeneratedKeysList}
----

Note that the value of this property depends on the specific JDBC driver and its limitations.
