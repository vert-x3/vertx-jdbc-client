 ...
 * <p>
 * The default encoder provides best efforts to convert {@code Java type} to {@code SQL type} as {@code JDBC 4.2} spec.
 * <p>
 ...
 * @since 4.2.0
 */
public interface JDBCEncoder extends JDBCParser {
