...
class JDBCConnectionImpl implements SQLConnection {
  ...
  public JDBCConnectionImpl(Context context, JDBCStatementHelper helper, Connection conn, PoolMetrics poolMetrics, Object metric) {
  ...
  public void close(Handler<AsyncResult<Void>> handler) {
    new JDBCClose(vertx, options, ctx, poolMetrics, metric).execute(conn, statementsQueue, handler);
  }
