...
public class JDBCUpdate extends AbstractJDBCAction<UpdateResult> {
  ...
  private PreparedStatement prepareStatement() throws SQLException {
    if (options != null) {
      if (options.getAutoGeneratedKeys() != null) {
        generateKeys = true;
        return conn.prepareStatement(sql, options.getAutoGeneratedKeys() ? Statement.RETURN_GENERATED_KEYS : Statement.NO_GENERATED_KEYS);
      }
