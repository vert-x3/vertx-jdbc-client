...
/**
 * Converter and mapper for {@link io.vertx.ext.sql.SQLOptions}.
...
public class SQLOptionsConverter {
  ...
  private static final Base64.Encoder BASE64_ENCODER = JsonUtil.BASE64_ENCODER;
   ...
   static void fromJson(Iterable<java.util.Map.Entry<String, Object>> json, SQLOptions obj) {
   ...
   static void toJson(SQLOptions obj, JsonObject json) {
    toJson(obj, json.getMap());
  }

   static void toJson(SQLOptions obj, java.util.Map<String, Object> json) {
